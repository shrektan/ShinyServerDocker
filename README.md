...
It's an antomated build docker image from [Github shrektan/ShinyServerDocker](https://github.com/shrektan/ShinyServerDocker).

This is a Dockerfile of my own working environment, which is based on rocker/shiny and rocker/hadleyverse. 

The image is available from [Docker Hub](https://hub.docker.com/r/shrektan/ShinyServerDocker/).
